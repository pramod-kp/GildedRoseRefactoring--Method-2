    ...
    public class GildedRoseTests
    {
        ...
        {           
            var items = new List<ItemList>
            {
                ...
                new ItemList {Name = "Aged Brie", SellIn = 2, Quality = 0, Resolver = "GildedRoseCSharpCore.Interfaces.IAgedBrieUpdateService"},
                new ItemList {Name = "Elixir of the Mongoose", SellIn = 5, Quality = 7},
                new ItemList {Name = "Sulfuras, Hand of Ragnaros", SellIn = 0, Quality = 80, Resolver = "GildedRoseCSharpCore.Interfaces.ILegendaryItemsUpdateService"},
                new ItemList {Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 15, Quality = 20, Resolver = "GildedRoseCSharpCore.Interfaces.IBackStagePassesUpdateService"},
                new ItemList {Name = "Conjured Mana Cake", SellIn = 3, Quality = 7, Resolver = "GildedRoseCSharpCore.Interfaces.IConjuredUpdateService"}
            };
            ...
            List<ItemList> expectedOutput = new List<ItemList>()
            {
                ...
                new ItemList { Name = "Conjured Mana Cake", SellIn = 2, Quality = 5 }
            };
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "+5 Dexterity Vest", SellIn = 0, Quality = 20 } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "+5 Dexterity Vest", SellIn = 0, Quality = 0 } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "Aged Brie", SellIn = 2, Quality = 0, Resolver = "GildedRoseCSharpCore.Interfaces.IAgedBrieUpdateService" } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
            List<ItemList> expectedOutput = new List<ItemList>() { new ItemList { Name = "Aged Brie", SellIn = 1, Quality = 1 } };
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "Aged Brie", SellIn = 2, Quality = 50, Resolver = "GildedRoseCSharpCore.Interfaces.IAgedBrieUpdateService" } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "Sulfuras, Hand of Ragnaros", SellIn = 0, Quality = 80, Resolver = "GildedRoseCSharpCore.Interfaces.ILegendaryItemsUpdateService" } };
            var app = new Program(_updateStrategy, items);            
            app.UpdateInventory();
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 15, Quality = 20, Resolver = "GildedRoseCSharpCore.Interfaces.IBackStagePassesUpdateService" } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 10, Quality = 20, Resolver = "GildedRoseCSharpCore.Interfaces.IBackStagePassesUpdateService" } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 5, Quality = 20, Resolver = "GildedRoseCSharpCore.Interfaces.IBackStagePassesUpdateService" } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 0, Quality = 20, Resolver = "GildedRoseCSharpCore.Interfaces.IBackStagePassesUpdateService" } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "Backstage passes to a TAFKAL80ETC concert", SellIn = 4, Quality = 49, Resolver = "GildedRoseCSharpCore.Interfaces.IBackStagePassesUpdateService" } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "Conjured Mana Cake", SellIn =5, Quality = 30, Resolver = "GildedRoseCSharpCore.Interfaces.IConjuredUpdateService" } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
        ...
        {
            List<ItemList> items = new List<ItemList>() { new ItemList { Name = "Conjured Mana Cake", SellIn = 1, Quality = 1, Resolver = "GildedRoseCSharpCore.Interfaces.IConjuredUpdateService" } };
            var app = new Program(_updateStrategy, items);
            app.UpdateInventory();
